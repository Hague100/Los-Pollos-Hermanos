...
<body style="height: 380px">
    <form id="form1" runat="server">
        <asp:Label ID="lblPatientId" runat="server" style="z-index: 1; left: 15px; top: 38px; position: absolute" Text="Patient ID" width="98px"></asp:Label>
        ...
        <asp:Label ID="lblPPhoneNo" runat="server" style="z-index: 1; left: 15px; top: 114px; position: absolute" Text="Phone Number " width="98px"></asp:Label>
        <asp:TextBox ID="txtPPhoneNo" runat="server" style="z-index: 1; left: 150px; top: 112px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblPDOB" runat="server" style="z-index: 1; left: 15px; top: 140px; position: absolute" Text="Date of Birth" width="98px"></asp:Label>
        <asp:TextBox ID="txtPDOB" runat="server" style="z-index: 1; left: 150px; top: 141px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblPHomeAdd" runat="server" style="z-index: 1; left: 15px; top: 168px; position: absolute" Text="Home Address" width="98px"></asp:Label>
