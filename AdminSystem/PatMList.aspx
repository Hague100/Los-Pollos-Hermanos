...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 107px; top: 398px; position: absolute" Text="Edit" OnClick="btnEdit_Click" width="68px" />
        </div>
        ...
        <p>
            &nbsp;</p>
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" style="z-index: 1; left: 15px; top: 398px; position: absolute" Text="Add" width="68px" />
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 25px; top: 588px; position: absolute"></asp:Label>
        <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" style="z-index: 1; left: 196px; top: 398px; position: absolute" Text="Delete" />
        ...
        <asp:Button ID="btnMainMenu" runat="server" OnClick="btnMainMenu_Click" style="z-index: 1; left: 591px; top: 527px; position: absolute" Text="Return to Main Menu" width="164px" />
    </form>
</body>
</html>
