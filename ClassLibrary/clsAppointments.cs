...
namespace ClassLibrary
{
    ...
    public class clsAppointments
    {
        ...
        public string Valid(string patientFirstName, string patientLastName, string dateOfAppointment, string timeOfAppointment, string floorNumber, string roomNumber, string notes)
        {
